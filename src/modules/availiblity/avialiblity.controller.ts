...
export const editSlot = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await updateAvailabilitySlot(
      Array.isArray(slotId) ? slotId[0] as string : slotId as string,
      updateData
    );
 ...
 */
export const getTutorSlots = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await getTutorAvailabilitySlots(
      tutorId as string,
      include
    );
...
export const getSlotById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await getAvailabilitySlotById(slotId as string);
...
export const deleteSlot = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await deleteAvailabilitySlot(slotId as string);
...
export const getAvailableSlots = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await getAvailableSlotsInRange(tutorId as string, start, end);
